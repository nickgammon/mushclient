...
//
////////////////////////////////////////////////////////////////////////////////
MString::MString(const char* in, const int max) : CString(in), maxlength (max)
{
}
...
//
////////////////////////////////////////////////////////////////////////////////
MString::MString(const CString& in, const int max) : CString(in), maxlength (max)
...
void MString::DoubleMetaphone(CString &metaph, CString &metaph2)
{
        ...
        ///////////main loop//////////////////////////
        while((primary.GetLength() < maxlength) OR (secondary.GetLength() < maxlength))
        {
                if(current >= length)
                        break;
        ...
        if(metaph.GetLength() > maxlength)
                metaph.SetAt(maxlength,'\0');
        if(alternate)
        {
                metaph2 = secondary;
                if(metaph2.GetLength() > maxlength)
                        metaph2.SetAt(maxlength,'\0');
        }
